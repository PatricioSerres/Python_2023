...
def armar1(carpeta_collage,data_set,perfil):
    size = (500,500)
    ...
    while True:
        ...
        if event == 'actualizar':
            ...
            if (-1< x < 500) and (-1 < y < 500):
                ...
                sg.popup_ok("Por favor, ingrese un valor del 0 y 500",title='Error X',background_color=("white"),text_color=('Black'),button_color=('green'))
            else:
